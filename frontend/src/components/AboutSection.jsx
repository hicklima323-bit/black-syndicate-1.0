...
export const AboutSection = () => {
  const features = [
    { icon: Shield, title: 'Segurança Total', description: 'Seus dados protegidos com criptografia de ponta.' },
    { icon: Zap, title: 'Acesso Instantâneo', description: 'Downloads e ativações imediatas após a compra.' },
    { icon: Target, title: 'Conteúdo Exclusivo', description: 'Materiais que você não encontra em outro lugar.' },
    { icon: Users, title: 'Comunidade Ativa', description: 'Suporte e networking com milhares de membros.' },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20">
          ...
          >
            ...
            >
              Sobre a BLACK SYNDICATE
            </h2>

            <p className="text-lg text-purple-400 mb-6">
              Uma nova era de acesso exclusivo
            </p>
