      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-500 text-sm max-w-xs mb-6">
              A maior plataforma de recursos digitais exclusivos do Brasil.
            </p>
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((item) => (
                ...
                >
                  <item.Icon className="w-5 h-5 text-gray-400 hover:text-purple-400 transition-colors" />
                </motion.a>
              ))}
            </div>
          </div>
          ...
          <FooterLinkGroup title="Suporte" links={supportLinks} />
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-600 text-sm" data-testid="copyright">
            © {currentYear} BLACK SYNDICATE. Todos os direitos reservados.
          </p>
