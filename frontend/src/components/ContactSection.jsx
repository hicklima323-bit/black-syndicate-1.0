      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 text-base md:text-lg max-w-2xl mx-auto mb-12">
            Faça parte do nosso grupo exclusivo e tenha acesso a conteúdos especiais.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <motion.a
              href="https://t.me/blacksyndicate"
              target="_blank"
              rel="noopener noreferrer"
          ...
          >
            <a
              href="https://wa.me/5500000000000?text=Olá, preciso de suporte"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              ...
              <span className="font-medium underline">Falar com Suporte</span>
            </a>
          </motion.div>
        </motion.div>
